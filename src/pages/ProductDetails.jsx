        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-20 items-start">
          ...
          <div className="flex flex-col justify-center lg:pr-8">
            ...
            <div className="flex items-baseline gap-3 mb-6 border-b border-gray-100 pb-6">
              ...
              <span className="text-sm md:text-lg text-gray-400 line-through font-light">₹ {product.price + 200}</span>
              {/* <span className="text-[10px] md:text-xs bg-green-100 text-green-800 px-2 py-1 rounded font-bold uppercase ml-auto md:ml-0">In Stock</span> */}
            </div>
            ...
            <div className="grid grid-cols-2 gap-y-6 gap-x-4 mb-8 bg-gray-50 p-4 rounded-lg md:bg-white md:p-0">
              <div>
                ...
                <span className="font-serif text-[#2F4F4F] text-sm md:text-lg font-medium">{product.pageQuality}</span>
              </div>
              <div>
              ...
              <div>
                ...
                <span className="font-serif text-[#2F4F4F] text-sm md:text-lg font-medium">{product.pages}</span>
              </div>
              <div>
                <span className="block text-gray-400 text-[10px] uppercase tracking-[0.2em] mb-1">S.No.</span>
                <span className="font-serif text-[#2F4F4F] text-sm md:text-lg font-medium">{product.id}</span>
              </div>
            </div>
